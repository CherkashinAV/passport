...
describe('/v1/registration_invite', () => {
	...
	const defaultBody = {
		...
		accessToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHBpcmVzSW4iOjE3MDQxOTkzMTY4MDYsInJvbGUiOiJtb2RlcmF0b3IiLCJ1c2VySWQiOiJhYWFhYWFhYS1mNjI1LTQxY2EtYTM1My0wNjhkNmVkNzBmYzUiLCJpYXQiOjE3MDQxOTkzMTN9.Yf9A2I0D9CAqZ0o36XVWvQENpuq58La_CNHVTvxZWrc'
	}
	...
	describe('registration invite', () => {
		...
		it('should respond with 401 when failed to verify token', async () => {
			const res = await httpClient.post({
				...defaultBody,
				accessToken: 'ey1111ciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHBpcmVzSW4iOjE3MDQxOTkzMTY4MDYsIwJvbGUiOiJtb2RlcmF0b3IiLCJ1c2VySWQiOiJhYWFhYWFhYS1mNjI1LTQxY2EtYTM1My0wNjhkNmVkNzBmYzUiLCJpYXQiOjE3MDQxOTkzMTN9.Yf9A2I0D9CAqZ0o36XVWvQENpuq58La_CNHVTvxZWrc'
			});
